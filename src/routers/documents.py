...
from src.handlers.authorization import Authentication
from src.handlers.data_ingestion import DataIngestion
from src.handlers.file_partition import DocumentExtraction

from src.repository.user_repository import UserRepository
from src.repository.file_repository import FileProcessingRepository, FileProcessingVecDB
...
async def extract_text(
    ...
    async def process_file(file: UploadFile):
        try:
            ...
            # Chuyển đổi đối tượng Document thành định dạng có thể serialize
            if result.status == "success" and result.data is not None:
                # Chuyển đổi các đối tượng Document thành dạng dict
                serializable_docs = []
                ...
                # Thay thế data trong result với phiên bản có thể serialize
                return BasicResponse(
